...
export const phasesData: Phase[] = [
  ...
  },
  {
    id: 'phase5b',
    displayId: '5b',
    headline: 'Webseite verbessern (Alternativ)',
    imageSrc: 'https://mintlify.s3.us-west-1.amazonaws.com/lovable-f9060f1e/lovable-editor-v2.png',
    imageAlt: 'Lovable editor interface with chat window',
    dataAiHint: 'website editor',
    description: 'Falls der vorherige Schritt nicht das gewünschte Ergebnis geliefert hat, kopiere diesen alternativen Prompt in das Chat-Fenster. Warte, bis der Plan erstellt ist, und klicke dann auf "Implement the Plan".',
    toolUrl: 'https://lovable.dev/',
    toolName: 'Lovable',
    toolIcon: Edit3,
    promptFileName: 'phase5b_webseite_verbessern_alternativ.txt',
    imageAspectRatio: 'video',
  },
  {
    id: 'phase5c',
    displayId: '5c',
    headline: 'Agent Image Prompt',
    imageSrc: 'https://placehold.co/600x400.png',
    imageAlt: 'AI agent avatar placeholder',
    dataAiHint: 'AI avatar',
    description: 'Nutze diesen Prompt in einem Bilderzeugungs-Tool innerhalb von Lovable oder einem anderen Dienst, um einen professionellen Avatar für den KI-Assistenten der Webseite zu erstellen.',
    toolUrl: 'https://lovable.dev/',
    toolName: 'Lovable',
    toolIcon: Edit3,
    promptFileName: 'phase5c_agent_image_prompt.txt',
    imageAspectRatio: 'video',
  },
  {
    id: 'phase6',
